...
func TestMain(t *testing.T) {
	// 测试代码执行后, 可通过执行 ./clear.sh cni-demo0 来清掉测试的操作,
	...
	args := &TestArgs{
		...
		Args:        "",
		Path:        "/opt/cni/bin",
		StdinData:   []byte("{\"bridge\":\"cni-demo0\",\"capabilities\":{\"test1\":true,\"test2\":false},\"cniVersion\":\"0.3.0\",\"name\":\"cni-demo\",\"subnet\":\"10.244.0.0/16\",\"type\":\"cni-demo\"}"),
	}
