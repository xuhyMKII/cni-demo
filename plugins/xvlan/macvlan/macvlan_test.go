...
func TestMacVlan(t *testing.T) {
	...
	args := &skel.CmdArgs{
		...
		Path:        "/opt/cni/bin",
		StdinData:   ([]byte)("{\"cniVersion\":\"0.3.0\",\"mode\":\"macvlan\",\"name\":\"cni-demo\",\"subnet\":\"192.168.64.0/24\",\"type\":\"cni-demo\",\"ipam\":{\"rangeStart\":\"192.168.64.200\",\"rangeEnd\":\"192.168.64.210\"}}"),
	}
	...
	pluginConfig.Name = "cni-demo"
	pluginConfig.Type = "cni-demo"
